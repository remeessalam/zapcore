...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-[5rem] bg-gradient-to-r from-gray-400 to-primary/70">
      <div className="wrapper text-center text-white flex flex-col gap-7">
        ...
        <div className="flex flex-col gap-5">
          ...
          <p data-aos="fade-up" className="desc max-w-[40rem] mx-auto">
            ...
            AR applications—that empower your business to thrive in a
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-5 mt-9">
            <div className="flex flex-col gap-5 h-full">
              <div
                data-aos="fade-right"
                className="p-5 border border-primary rounded-xl w-full h-full bg-gray-600"
              >
                <div className="flex w-full text-start items-center justify-between gap-3">
                  ...
                  <img
                    ...
                    className="h-[3rem] object-contain mb-3 grayscale"
                    alt=""
                  />
                </div>
                <p className="desc text-white/80 text-start mt-3">
                  Our team leverages years of experience and advanced technical
                  skills to build robust, high-performing solutions.
                </p>
              </div>
              <div
                data-aos="fade-right"
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  We harness cutting-edge technology and creative strategies to
                  drive digital transformation and adapt to evolving market
                  trends.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  We prioritize clear, transparent communication to ensure your
                  vision is realized from concept to launch.
                </p>
              </div>
              <div
                data-aos="fade-left"
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  We adhere to strict cybersecurity standards and best practices
                  to safeguard your data and ensure regulatory compliance.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="pt-[3rem]">
          <div
            ref={ref}
            data-aos="fade-up"
            className="w-full grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10 lg:gap-5 rounded-3xl bg-gradient-to-r from-gray-700 to-gray-500 p-[2rem]"
          >
